...
export const JUNIOR_CURRICULUM_UNITS: UnitNotes[] = [
  {
    ...
    "illustrations": [
      {
        "caption": "Banuna Pizzeria Price Board",
        "icon": "🍕",
        "description": "Pizza slice: 25 Nakfa | Fresh juice: 15 Nakfa"
      },
      {
        "caption": "Equation Balancer Scale",
        "icon": "⚖️",
        "description": "Both sides of an equation must maintain exact equality: 25p + 15j = Total Nakfa"
      }
    ],
    "sections": [
      {
  ...
  },
  {
    ...
    "illustrations": [
      {
        "caption": "Number Line Integers",
        "icon": "↔️",
        "description": "Negative numbers extend left of zero; positive numbers extend right"
      }
    ],
    "sections": [
      {
  ...
  },
  {
    ...
    "illustrations": [
      {
        "caption": "Factor Tree for 60",
        "icon": "🌳",
        "description": "60 = 2 × 30 = 2 × 2 × 15 = 2² × 3 × 5"
      }
    ],
    "sections": [
      {
  ...
  },
  {
    ...
    "illustrations": [
      {
        "caption": "Compound Optical Microscope",
        "icon": "🔬",
        "description": "Eyepiece (10x), Revolving Nosepiece, Objective lenses (4x, 10x, 40x), Stage clips, Light source"
      },
      {
        "caption": "Plant vs Animal Cell",
        "icon": "🌿",
        "description": "Plant cells have chloroplasts and rigid cell walls; animal cells have flexible membranes"
      }
    ],
    "sections": [
      {
  ...
  },
  {
    ...
    "illustrations": [
      {
        "caption": "The Six Zobas of Eritrea",
        "icon": "🗺️",
        "description": "Maekel (Asmara), Debub (Mendefera), Anseba (Keren), Gash-Barka (Barentu), Semenawi Keyih Bahri (Massawa), Debubawi Keyih Bahri (Assab)"
      }
    ],
    "sections": [
      {
  ...
  },
  {
    ...
    "illustrations": [
      {
        "caption": "Community Solidarity",
        "icon": "🤝",
        "description": "Helping elders and participating in shared neighborhood tasks"
      }
    ],
    "sections": [
      {
    ...
    "exercises": [
      {
        ...
        "options": [
          "Littering the schoolyard",
          "Writing on classroom walls",
          "Taking care of library books and helping peers",
  ...
  },
  {
    ...
    "illustrations": [
      {
        "caption": "Reading Folktales",
        "icon": "📖",
        "description": "Traditional stories conveying wisdom, honesty, and bravery"
      }
    ],
    "sections": [
      {
  ...
  },
  {
    ...
    "illustrations": [
      {
        "caption": "Rational Numbers on Number Line",
        "icon": "📏",
        "description": "Fractions and negative fractions sit between whole integers"
      }
    ],
    "sections": [
      {
  ...
  },
  {
    ...
    "illustrations": [
      {
        "caption": "Human Digestive Tract",
        "icon": "🍎",
        "description": "Mouth -> Esophagus -> Stomach -> Small Intestine -> Large Intestine"
      }
    ],
    "sections": [
      {
  ...
  },
  {
    ...
    "illustrations": [
      {
        "caption": "Historic Port of Adulis",
        "icon": "⛵",
        "description": "Ancient Red Sea maritime gateway on the Gulf of Zula"
      }
    ],
    "sections": [
      {
  ...
  },
  {
    ...
    "illustrations": [
      {
        "caption": "Hillside Terracing",
        "icon": "🌱",
        "description": "Stepped stone terraces preventing rainwater soil erosion"
      }
    ],
    "sections": [
      {
    ...
    "exercises": [
      {
        ...
        "options": [
          "To build highways",
          "To prevent soil erosion and retain soil moisture",
          "To extract minerals",
          "To build sports arenas"
        ],
  ...
  },
  {
    ...
    "illustrations": [
      {
        "caption": "Active to Passive Conversion",
        "icon": "🔄",
        "description": "Subject and object swap positions with auxiliary 'be' + V3"
      }
    ],
    "sections": [
      {
  ...
  },
  {
    ...
    "illustrations": [
      {
        "caption": "Pythagorean Theorem Triangle",
        "icon": "📐",
        "description": "In a right triangle with sides 6 cm and 8 cm: 6² + 8² = 36 + 64 = 100 = 10²"
      }
    ],
    "sections": [
      {
  ...
  },
  {
    ...
    "illustrations": [
      {
        "caption": "Meiosis vs Mitosis",
        "icon": "🧬",
        "description": "Mitosis creates 2 clone body cells (2n=46); Meiosis creates 4 haploid gametes (n=23)"
      }
    ],
    "sections": [
      {
    ...
    "illustrations": [
      {
        ...
        "icon": "💻",
        "description": "Registers -> CPU Cache -> RAM (Volatile) -> Storage Drive (Non-volatile)"
      }
    ],
    "sections": [
      {
  ...
  },
  {
    ...
    "illustrations": [
      {
        "caption": "Historical Timeline of Eritrea",
        "icon": "🏛️",
        "description": "1961: Struggle begins at Mount Adal | 1991: Liberation of Asmara | 1993: Sovereign Referendum"
      }
    ],
    "sections": [
      {
  ...
  },
  {
    ...
    "illustrations": [
      {
        "caption": "Pillars of Civic Duty",
        "icon": "⚖️",
        "description": "Integrity, Social Justice, Communal Solidarity, Respect for the Constitution"
      }
    ],
    "sections": [
      {
    ...
    "illustrations": [
      {
        ...
        "icon": "🎯",
        "description": "Specific, Measurable, Achievable, Relevant, Time-bound goals for school success"
      }
    ],
    "sections": [
      {
  ...
  },
  {
    ...
    "illustrations": [
      {
        "caption": "Reported Speech Tense Shift",
        "icon": "🗣️",
        "description": "'I am studying' (Direct) -> He said that he was studying (Reported)"
      }
    ],
    "sections": [
      {
